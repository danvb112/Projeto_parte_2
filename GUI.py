...
def home_menu():
    ...
    bt2 = Button(janela_principal, width=20, text= "Professores" )
    bt3 = Button(janela_principal, width=20, text= "Disciplinas" )
    bt4 = Button(janela_principal, width=20, text= "Sair" )
...
def janela_atualizar_aluno():
    ...
    def bt_click():
        ...
        if aluno.atualizar_banco(novo_nome, novo_cpf):
